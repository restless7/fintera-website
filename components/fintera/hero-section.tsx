...
export default function HeroSection() {
  ...
  // Overlay fades out during the first half of the scroll container (the "extra" 100vh)
  const imageOpacity = useTransform(scrollYProgress, [0, 0.5], [1, 0]);

  return (
    <div ref={sectionRef} className="relative" style={{ height: "200vh" }}>
      {/* CTA Image Overlay - sits ABOVE everything, fades out on scroll */}
      <motion.div
      ...
      <section className="sticky top-0 min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-fintera-50 to-gradient-from/10 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Subtle grid pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#0ea5e950_1px,transparent_1px),linear-gradient(to_bottom,#0ea5e950_1px,transparent_1px)] bg-[size:40px_40px] opacity-10" />
